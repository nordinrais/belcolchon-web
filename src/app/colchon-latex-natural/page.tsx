...
export default function LatexNaturalPage() {
    ...
    return (
        <>
            ...
            <section className="relative min-h-[450px] md:min-h-[500px] flex items-center pt-24 pb-12 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/colchon-latex-natural/hero-latex-natural.png"
                        alt="Colchón de Látex 100% Natural"
                        fill
                ...
                <div className="container">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                        ...
                        <div className="bg-white p-1 rounded-2xl overflow-hidden shadow-lg group">
                            <div className="relative h-full min-h-[300px] rounded-xl overflow-hidden">
                                <Image
                                    src="/images/colchon-latex-natural/sistema-ergonomico.png"
